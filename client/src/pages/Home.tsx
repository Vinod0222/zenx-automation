          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
            {[
              ...
              >
                ...
                <div className={`w-16 h-16 rounded-2xl bg-white/5 flex items-center justify-center mx-auto mb-6 ${useCase.color} group-hover:scale-110 group-hover:bg-white/10 transition-all duration-500 shadow-xl`}>
